...
export default function ChallengeGalaxy() {
  const hackathons = [
    ...
    },
    {
      ...
      outcome: 'Started solo, assembled a team mid-hackathon. Learned more about leadership in 12 hours than in 12 months.',
      color: '#a070e0',
    },
  ]
